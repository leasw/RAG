...
세 번째 도구다.
    ...
    retrieve_memory   STM/MTM — 채팅에서 나온 휘발성 맥락
    search_documents  LTM 전문 검색 — "무엇이 적혀 있나"
    search_graph      LTM 위의 관계 그래프 — "무엇이 무엇과 어떻게 엮이나"

범위는 LTM뿐이고, 그 안에서도 schema.py에 정의된 개체(기관/인물/과제/과업/문서/제품/
정량목표)만 노드다. 정의 밖 개념은 그래프에 없으므로 그럴 땐 search_documents로
가라고 결과에 명시한다.
